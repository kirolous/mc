...
```sh
go install github.com/kirolous/mc@latest
```
...
Please follow MinIO [Contributor's Guide](https://github.com/kirolous/mc/blob/master/CONTRIBUTING.md)

## License
Use of `mc` is governed by the GNU AGPLv3 license that can be found in the [LICENSE](https://github.com/kirolous/mc/blob/master/LICENSE) file.
