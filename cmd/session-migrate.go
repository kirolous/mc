...
func migrateSessionV7ToV8() {
	for _, sid := range getSessionIDs() {
		...
		if err != nil {
			...
			fatalIf(err.Trace(sid), "Unable to load version `7`. Migration failed please report this issue at https://github.com/kirolous/mc/issues.")
		}
		...
		fatalIf(probe.NewError(e), "Unable to load version `7`. Migration failed please report this issue at https://github.com/kirolous/mc/issues.")
...
func migrateSessionV6ToV7() {
	for _, sid := range getSessionIDs() {
		...
		if err != nil {
			...
			fatalIf(err.Trace(sid), "Unable to load version `6`. Migration failed please report this issue at https://github.com/kirolous/mc/issues.")
		}

		sessionVersion, e := strconv.Atoi(sV6Header.Version)
		fatalIf(probe.NewError(e), "Unable to load version `6`. Migration failed please report this issue at https://github.com/kirolous/mc/issues.")
